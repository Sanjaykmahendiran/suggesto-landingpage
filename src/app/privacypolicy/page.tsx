...
export default function PrivacyPolicy() {
    ...
    useEffect(() => {
        const fetchPrivacyPolicy = async () => {
            try {
                const response = await fetch("https://suggesto.xyz/App/api.php?gofor=privacypolicy");
                ...
                <div className="container mx-auto px-4 py-8">
                    <div className="text-center py-12">
                        <div className="bg-red-50 border border-red-200 rounded-lg p-6 max-w-md mx-auto">
                            <h2 className="text-xl font-semibold text-red-800 mb-2">Unable to Load Privacy Policy</h2>
            ...
            <div className="min-h-screen">
                ...
                <div className="container mx-auto px-4 py-8">
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-600">The privacy policy content could not be found.</p>
                    </div>
                </div>
                <LandingPageFooter />
            </div>
            ...
            <div className="container mx-auto px-4 py-8">
                <main className="prose prose-gray max-w-none dark:prose-invert">
                    ...
                    <div className="mt-6 flex justify-center">
                        <div
                            className="max-w-[800px] w-full font-thin privacy-content"
