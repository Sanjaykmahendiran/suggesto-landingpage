...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 transition-transform duration-100 ease-in-out active:scale-95",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-r from-[#b56bbc] to-[#7a71c4] text-white font-bold hover:from-[#7a71c4] hover:to-[#b56bbc] transition-all duration-300",
        ...
        gradient:
          "bg-gradient-to-r from-[#b56bbc] to-[#7a71c4] text-white font-bold hover:from-[#7a71c4] hover:to-[#b56bbc] transition-all duration-300",
      },
      size: {
