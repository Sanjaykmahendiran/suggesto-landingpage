...
import MovieBuddies from "@/assets/connect-with-buddies.png"
        ...
        {features.map((feature, index) => (
          <div key={index} className={`grid md:grid-cols-2 gap-12 items-center`}>
            ...
            <div className={`${index % 2 === 1 ? "md:order-1" : ""}`}>
              <p className="bg-gradient-to-r from-[#b56bbc] to-[#7a71c4] bg-clip-text text-transparent text-lg font-medium mb-2">
                {feature.subtitle}
              </p>
